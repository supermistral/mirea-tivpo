...
feature {NONE} -- Initialization
	...
	make (a_id: INTEGER; 
	a_haircuts: INTEGER; 
	a_shop: separate BARBERSHOP; 
	a_sofa: separate ROOM;  
	a_barbers: separate BARBER_LIST)  
	...
	step
		...
		do
			if enter (shop) then
				...
				checkout (barber) -- to the assigned barber
